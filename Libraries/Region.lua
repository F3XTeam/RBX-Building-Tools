...
local function BoxPointCollision(CFrame,Size,Point)
...
local function BoxSphereCollision(CFrame,Size,Center,Radius)
...
local function BoxCollision(CFrame0,Size0,CFrame1,Size1,AssumeTrue)
	local	m00,m01,m02,
	m03,m04,m05,
	m06,m07,m08,
