...
function Frame:render()
	...
	if props.AspectRatio then
		...
		if props.DominantAxis == Enum.DominantAxis.Width then
			props.SizeConstraint = Enum.SizeConstraint.RelativeXX.Value
		...
		elseif props.DominantAxis == Enum.DominantAxis.Height then
			props.SizeConstraint = Enum.SizeConstraint.RelativeYY.Value
	...
	if props.Layout == 'List' then
		local Layout = new('UIListLayout', {
			...
			SortOrder = props.SortOrder or Enum.SortOrder.LayoutOrder.Value,
